<main class="content">
    <?php
    //configurações css feitas em public/assets/css/template
        renderTitle(
            'Relatório Gerencial',
    ...
    <div class="summary-boxes">
        <div class="summary-box bg-primary">
            ...
            <h3 class="value"><?= $usuariosAtivos ?></h3>
        </div>
        <div class="summary-box bg-danger">
            <i class="icon icofont-patient-bed"></i>
            <p class="title">Faltas</p>
            <h3 class="value"><?= count($usuariosAusentes) ?></h3>
        </div>
        <div class="summary-box bg-success">
            <i class="icon icofont-sand-clock"></i>
            <p class="title">Horas no Mês</p>
            <h3 class="value"><?= $horasNoMes ?></h3>
        </div>
    </div>

    <?php if(count($usuariosAusentes) > 0): ?>
        <div class="card mt-4">
            ...
            <div class="card-body">
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        <?php foreach($usuariosAusentes as $name): ?>
                            <tr>
                                <td><?= $name ?></td>
                            </tr>
                        <?php endforeach ?>
